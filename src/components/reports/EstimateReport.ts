...
.brand { display:flex; align-items:center; gap:12px; }.brand-mark { display:grid; place-items:center; width:38px; height:38px; border-radius:10px; background:#087b80; color:#fff; font-size:22px; font-weight:800; }.brand-logo { width:36px; height:36px; object-fit:contain; }
...
@media screen { .estimate-report { margin:24px auto; box-shadow:0 8px 28px rgb(16 32 39 / .12); } }
@media print {
  @page { margin: .25in; }
  body { background:#fff; }
  .estimate-report { width:100%; min-height:auto; margin:0; padding:0; box-shadow:none; }
  .report-header,.report-footer { gap:16px; }
  .brand-logo { width:32px; height:32px; }
  .brand-name { font-size:20px; }.tagline,.generated,.report-footer { font-size:10px; }.report-title { font-size:18px; }
  .rule { margin:10px 0 14px; }.project-heading { margin-bottom:12px; } h1 { font-size:23px; }.project-type { margin-top:6px; font-size:12px; }
  .report-columns { gap:16px; }.report-stack { gap:12px; }.report-section h2,.custom-section h2 { margin-bottom:7px; font-size:13px; }
  .report-row { padding:7px 10px; font-size:11px; }.report-row--emphasis { font-size:12px; }
  .primary-result { padding:12px; }.primary-result h2,.summary h2 { font-size:12px; }.primary-value { margin-top:12px; font-size:42px; }.primary-support { margin-top:7px; font-size:12px; }.confirmation { margin-top:12px; font-size:11px; }
  .summary { padding-top:12px; }.summary h2 { margin:0 12px 9px; }.custom-section { font-size:11px; line-height:1.4; }.custom-section .equation { margin-top:10px; gap:6px; }.equation-box { padding:7px 4px; font-size:10px; }.equation-box strong { font-size:12px; }.equation-result { margin-top:8px; padding:7px; }.equation-result strong { font-size:21px; }
  .notice { padding:10px; font-size:10px; line-height:1.4; }.report-footer { margin-top:12px; padding-top:8px; }
}
@media (max-width:680px) { .estimate-report { padding:18px; }.report-header,.report-footer { flex-direction:column; }.report-title,.generated { text-align:left; }.report-columns { grid-template-columns:1fr; }.primary-value { font-size:42px; } }
`;
